        ...
        <div className={styles.container}>
            <aside className={styles.sidebar}>
                ...
                <nav className={styles.nav}>
                    ...
                    <Link to="/admin/users" className={styles.active}>Users</Link>
                    ...
                    <div className={styles.filterSection}>
                        ...
                        <div className={styles.filterGroup}>
                            ...
                            <div className={styles.filterTabs}>
                                ...
                                <button
                                    className={statusFilter === 'INACTIVE' ? styles.activeTab : ''}
                            ...
                            <table className={styles.table}>
                                ...
                                <tbody>
                                    {filteredUsers.length === 0 ? (
                                        <tr><td colSpan={8} style={{ textAlign: 'center', padding: '20px' }}>No users found for selected filters.</td></tr>
                                    ) : (
                                        filteredUsers.map((u) => (
                                            <tr key={u.id}>
                                                <td>{u.name}</td>
                                                <td>{u.email}</td>
                                                <td><span className={`${styles.badge} ${styles[`badge${u.role}`]}`}>{u.role}</span></td>
                                                <td>
                                                    <span className={`${styles.badge} ${styles[`badge${u.status}`]}`}>
                                                        {u.status}
                                                    </span>
                                                </td>
